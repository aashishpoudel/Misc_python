...
widget_chkbox = [1,0,0]
widget_status=['normal','disabled','disabled']

for widgetIdx, myWidget in enumerate(myWidgets):
	...
	Label(window, textvariable=myWidget['label'], state=widget_status[widgetIdx], relief=SUNKEN).grid(row=r,column=0,padx=5, pady=5)
	...
	if myWidget['name'] is 'Website':
		...
		Entry(window, textvariable=myWidget['addressText'], state=widget_status[widgetIdx]).grid(row=r, column=1, padx=5, pady=5)
	...
	Entry(window, textvariable=myWidget['time'], state=widget_status[widgetIdx]).grid(row=r, column=2, padx=5, pady=5)
	myWidget['time'].set(widget_time[widgetIdx])
	Checkbutton(window, text="", variable=myWidget['chkbtn'], state=widget_status[widgetIdx]).grid(row=r, column=3, padx=5, pady=5)
